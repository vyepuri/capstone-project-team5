...
Our proposed solution will be dealing with a stateless polyglot microservices, containerized used docker and kubernetes.We deploy our application and analyse the improved performance using kubernetes.
...
\begin{table}[h]
  ...
  ~\cite{vayghan2019microservice} & \checkmark & \checkmark & \checkmark & \checkmark  & X \\ \hline 
  ~\cite{medel2016modelling} & X & X & \checkmark & \checkmark  & X \\ \hline
  ~\cite{sharma2020docker} & X & X & \checkmark & X  & X \\ \hline
  ~\cite{zhang2019grit} & \checkmark & \checkmark & \checkmark & X  & \checkmark \\ \hline 
  ~\cite{amaral2015performance} & \checkmark & X & \checkmark & X  & \checkmark \\ \hline
Ours & \checkmark & \checkmark & \checkmark & \checkmark  & \checkmark \\ \hline
